...
class ShuffleUNet(nn.Module):
    ...
    def __init__(self, in_ch=1, num_features=64, out_ch=1, kernel_size_1=3, stride_1=1, kernel_size_3=1):
        ...
        #Pixel Shuffles
        self.pixel_1 = pixel_shuffle.PixelShuffle(num_features * 16, num_features * 16 * (2 ** 2), kernel_size_1, stride_1)
        self.pixel_2 = pixel_shuffle.PixelShuffle(num_features * 8, num_features * 8 * (2 ** 2), kernel_size_1, stride_1)
        self.pixel_3 = pixel_shuffle.PixelShuffle(num_features * 4, num_features * 4 * (2 ** 2), kernel_size_1, stride_1)
        self.pixel_4 = pixel_shuffle.PixelShuffle(num_features * 2, num_features * 2 * (2 ** 2), kernel_size_1, stride_1)

        #Pixel Unshuffles
        self.pixel_unshuffle_1 = pixel_unshuffle.PixelUnshuffle(num_features, num_features, 3, 1)
        self.pixel_unshuffle_2 = pixel_unshuffle.PixelUnshuffle(num_features * 2, num_features * 2, 3, 1)
        self.pixel_unshuffle_3 = pixel_unshuffle.PixelUnshuffle(num_features * 4, num_features * 4, 3, 1)
        self.pixel_unshuffle_4 = pixel_unshuffle.PixelUnshuffle(num_features * 8, num_features * 8, 3, 1)
