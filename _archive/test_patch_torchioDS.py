...
def parseARGS():
    ...
    ap.add_argument("-us", "--us", default='Center6p25MaskWoPad145_Tri_Norm', help="Undersample.")
    ...
    ap.add_argument("-m", "--modelname", default="usCHAOSWoT2_UNETdo0.0dp3upconv_Center6p25MaskWoPad_Tri_Norm_pLossL1lvl3", help="Model to Load for testing.")
    ...
    ap.add_argument("-pst", "--patchstride", default='(6,6,6)', help="Stride of patches, to be used during validation")
