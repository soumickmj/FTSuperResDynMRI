...
if __name__ == "__main__" :
    ...
    testDS = SRDataset(logger=logging, patch_size=args.patchsize[0], dir_path=dir_path, label_dir_path=label_dir_path, #TODO: implement non-iso patch-size, now only using the first element
                        ...
                        patch_size_us=None, return_coords=True, pad_patch=True, pre_interpolate=args.preint, norm_data=False, pre_load=True) #TODO implement patch_size_us if required - patch_size//scaling_factor
