...
def parseARGS():
    ...
    ap.add_argument("-ms", "--modelsuffix", default='X', help="Any Suffix To Add with the Model Name.")
    ap.add_argument("-bs", "--batchsize", type=int, default=2, help="Batch Size.")
...
if __name__ == "__main__" :
    ...
    trainDS = createTIODynDS(path_gt=label_dir_path, path_corrupt=dir_path, is_infer=False, p=1, transforms=transforms)
